...
import { GetFetchPoolSchedules } from "../lib/react-query/get-fetch-pool-schedules";
...
export default function Form() {
    ...
    // Funções do useMutation referentes aos agendamentos
    const { data: dataPoolSchedules } = GetFetchPoolSchedules()
    ...
    const { mutate: mutateSchedule } = CreateMutateSchedule()
    ...
    useEffect(() => {
        ...
        if (dataPoolSchedules && dataPoolSchedules.length > 0) {

            // Filtrar as datas e horas ocupadas
            const occupied: { date: string, hour: string }[] = dataPoolSchedules.map((schedule: any) => {
                return {
                            ...
                            <div className="flex justify-start items-center gap-10">
                                ...
                                <DivLabelAndInput>
                                    ...
                                    >
                                        ...
                                        {Array.from(['07:00', '08:00', '09:00', '10:00', '11:00', '12:00'], (hour, index) => {
